  ...
  def main(args: Array[String]): Unit = {
    ...
    stream1.keyBy(_.car)
      ...
      .process(new ProcessJoinFunction[ViolationInfo, PoliceAction, String]{
        ...
        override def processElement(left: ViolationInfo, right: PoliceAction, context: ProcessJoinFunction[ViolationInfo, PoliceAction, String]#Context, out: Collector[String]): Unit = {
