...
public class CreateDatas {
    ...
    public static void main(String[] args) {
        ...
        String result = null;
        String[] locations = {"湘","京","京","京","京","京","冀","鲁","皖","鄂"};
        //模拟生成一天的数据
        String day ="2022-12-04";
        ...
        try{
            ...
            for (int i = 0; i < 30000; i++) {
               ...
               String car =  locations[r.nextInt(locations.length)] + (char)(65 + r.nextInt(26)) +  String.format("%05d",r.nextInt(100000));
                ...
                double v = rg.nextNormalizedDouble(); // 标准高斯分布的随机数据, 大概率在-1到1
                ...
                for ( int j = 0; j < count; j++) {
                    ...
                    String speed =String.format("%.1f",Math.abs(40+(40*v2))); //均值40，标准差是40
